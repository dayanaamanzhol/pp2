...
class Coin(pygame.sprite.Sprite):
  def __init__(self):
      super().__init__()
      self.coin_images = [
          pygame.image.load("PygameTutorial_3_0/coin.png"),
          pygame.image.load("PygameTutorial_3_0/coin_2.png"),
          pygame.image.load("PygameTutorial_3_0/coin_3.png"),
      ]
      self.weight = random.randint(1, 3)  
      self.image = self.coin_images[self.weight - 1]  
      self.rect = self.image.get_rect()
      self.rect.center = (random.randint(40, w - 40), 0)
...
coin_count = 1  # Number of coins to create
